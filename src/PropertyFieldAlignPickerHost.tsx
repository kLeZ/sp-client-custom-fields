...
export default class PropertyFieldAlignPickerHost extends React.Component<IPropertyFieldAlignPickerHostProps, IPropertyFieldAlignPickerHostState> {
  ...
  public render(): JSX.Element {
    ...
    if (this.state.mode == "left") backgroundLists = "#EEEEEE";
    if (this.state.mode == "center") backgroundTiles = "#EEEEEE";
    if (this.state.mode == "right") backgroundRight = "#EEEEEE";
    ...
    if (this.state.mode === "left") styleLeft += " is-checked";
    else if (this.state.mode === "center") styleCenter += " is-checked";
    else if (this.state.mode === "right") styleRight += " is-checked";
      ...
      <div style={{ marginBottom: "8px" }}>
        ...
        <div style={{ display: "inline-flex" }}>
              ...
              <label htmlFor={"leftRadio-" + this._key} className={styleLeft}>
                <div className={styles["spcfChoiceFieldInnerField"]}>
                  <div className={styles["spcfChoiceFieldIconWrapper"]}>
                    <i
                      className="ms-Icon ms-Icon--AlignLeft"
                      aria-hidden="true"
                      style={{
                        cursor: this.props.disabled === false ? "pointer" : "default",
                        fontSize: "32px",
            ...
            <div style={{ float: "left" }} className={styles["spcfChoiceField"]}>
              ...
              <label htmlFor={"centerRadio-" + this._key} className={styleCenter}>
                <div className={styles["spcfChoiceFieldInnerField"]}>
                  <div className={styles["spcfChoiceFieldIconWrapper"]}>
                    <i
                      className="ms-Icon ms-Icon--AlignCenter"
                      aria-hidden="true"
                      style={{
                        cursor: this.props.disabled === false ? "pointer" : "default",
                        fontSize: "32px",
          ...
          <div
            ...
            onMouseEnter={this.mouseRightEnterDropDown}
            onMouseLeave={this.mouseRightLeaveDropDown}
          >
            <div style={{ float: "left" }} className={styles["spcfChoiceField"]}>
              <input
                id={"rightRadio-" + this._key}
                className={styles["spcfChoiceFieldInput"]}
              ...
              <label htmlFor={"rightRadio-" + this._key} className={styleRight}>
                <div className={styles["spcfChoiceFieldInnerField"]}>
                  <div className={styles["spcfChoiceFieldIconWrapper"]}>
                    <i
                      className="ms-Icon ms-Icon--AlignRight"
                      aria-hidden="true"
                      style={{
                        cursor: this.props.disabled === false ? "pointer" : "default",
                        fontSize: "32px",
