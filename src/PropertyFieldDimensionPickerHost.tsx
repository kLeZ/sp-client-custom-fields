 ...
 * Renders the controls for PropertyFieldDimensionPicker component
 */
export default class PropertyFieldDimensionPickerHost extends React.Component<
  IPropertyFieldDimensionPickerHostProps,
  IPropertyFieldDimensionPickerState
> {
  private async: Async;
  private delayedValidate: (value: IPropertyFieldDimension) => void;
  private _key: string;
  private units: IDropdownOption[] = [{ key: "px", text: "px" }, { key: "%", text: "%" }];
  ...
  public componentWillUnmount() {
    if (this.async != null) this.async.dispose();
  }
            ...
            <tr>
              ...
              <td style={{ verticalAlign: "top" }}>
                <Dropdown
                  label=""
                  options={this.units}
                  selectedKey={this.state.widthUnit}
                  disabled={this.props.disabled}
            ...
            <tr>
              ...
              <td style={{ verticalAlign: "top" }}>
                <Dropdown
                  label=""
                  options={this.units}
                  selectedKey={this.state.heightUnit}
                  disabled={this.props.disabled}
