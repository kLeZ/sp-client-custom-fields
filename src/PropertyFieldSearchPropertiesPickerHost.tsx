 ...
 * Renders the controls for PropertyFieldSearchPropertiesPicker component
 */
export default class PropertyFieldSearchPropertiesPickerHost extends React.Component<
  IPropertyFieldSearchPropertiesPickerHostProps,
  IPropertyFieldSearchPropertiesPickerState
> {
  ...
  private getSelectedProperties(): ITag[] {
    var res: ITag[] = [];
    if (this.props.selectedProperties === undefined) return res;
  ...
  private validate(value: string[]): void {
    ...
    if (result !== undefined) {
      if (typeof result === "string") {
        if (result === undefined || result === "") this.notifyAfterValidate(this.props.selectedProperties, value);
        this.setState({ errorMessage: result } as IPropertyFieldSearchPropertiesPickerState);
      } else {
        result.then((errorMessage: string) => {
          if (errorMessage === undefined || errorMessage === "") this.notifyAfterValidate(this.props.selectedProperties, value);
  ...
  private onFilterChanged(filterText: string, tagList: ITag[]) {
    return filterText
      ? this.state.properties
          ...
          .filter(item => !this.listContainsTag(item, tagList))
      : [];
  }
