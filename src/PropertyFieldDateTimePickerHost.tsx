 ...
 * Renders the controls for PropertyFieldDateTimePicker component
 */
export default class PropertyFieldDateTimePickerHost extends React.Component<
  IPropertyFieldDateTimePickerHostProps,
  IPropertyFieldDateTimePickerHostPropsState
> {
          ...
          <tbody>
            <tr>
              <td style={{ verticalAlign: "top" }}>
                <Label style={{ marginRight: "4px" }}>{strings.DateTimePickerDate}</Label>
              </td>
              <td style={{ verticalAlign: "top" }}>
                <DatePicker
            ...
            <tr>
              <td style={{ verticalAlign: "top" }}>
                <Label style={{ marginRight: "4px" }}>{strings.DateTimePickerTime}</Label>
              </td>
              <td style={{ verticalAlign: "top" }}>
