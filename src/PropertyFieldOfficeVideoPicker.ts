...
class PropertyFieldOfficeVideoPickerBuilder implements IPropertyPaneField<IPropertyFieldOfficeVideoPickerPropsInternal> {
  ...
  public properties: IPropertyFieldOfficeVideoPickerPropsInternal;
   ...
   * Ctor
   */
  public constructor(_targetProperty: string, _properties: IPropertyFieldOfficeVideoPickerPropsInternal) {
  ...
  private render(elem: HTMLElement): void {
    ...
    const element: React.ReactElement<IPropertyFieldOfficeVideoPickerHostProps> = React.createElement(PropertyFieldOfficeVideoPickerHost, {
      label: this.label,
