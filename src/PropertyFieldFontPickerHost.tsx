...
export default class PropertyFieldFontPickerHost extends React.Component<IPropertyFieldFontPickerHostProps, IPropertyFieldFontPickerHostState> {
  ...
  private fonts: ISafeFont[] = [
    ...
    {
      Name: "Calisto MT",
      SafeValue: '"Calisto MT","Bookman Old Style",Bookman,"Goudy Old Style",Garamond,"Hoefler Text","Bitstream Charter",Georgia,serif',
    },
    ...
    {
      Name: "Impact",
      SafeValue: 'Impact,Haettenschweiler,"Franklin Gothic Bold",Charcoal,"Helvetica Inserat","Bitstream Vera Sans Bold","Arial Black","sans serif"',
    },
              ...
              <ul style={fsResults}>
                {this.fonts.map((font: ISafeFont, index: number) => {
                  ...
                  return (
                    <li
                      value={font.Name}
                      key={this._key + "-fontpicker-" + index}
                      role="menuitem"
