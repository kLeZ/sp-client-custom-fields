 ...
 * Renders the controls for PropertyFieldDocumentPicker component
 */
export default class PropertyFieldDocumentPickerHost extends React.Component<
  IPropertyFieldDocumentPickerHostProps,
  IPropertyFieldDocumentPickerHostState
> {
  ...
  private handleIframeData(element?: any) {
    if (this.state.openSite != true || this.state.openPanel != true) return;
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <IconButton
                          disabled={
                            this.props.disabled === false && (this.state.selectedImage != null && this.state.selectedImage != "") ? false : true
                          }
            ...
            <div style={{ backgroundColor: "#F4F4F4", width: "100%", height: "80vh", paddingTop: "0px", display: "inline-flex" }}>
              <div style={{ width: "206px", backgroundColor: "white" }}>
                ...
                <div
                  ...
                  role="menuitem"
                >
                  <i className="ms-Icon ms-Icon--Clock" style={{ fontSize: "30px" }} />
                  &nbsp;
                ...
                <div
                  ...
                  role="menuitem"
                >
                  <i className="ms-Icon ms-Icon--Globe" style={{ fontSize: "30px" }} />
                  &nbsp;
              ...
              <div
                ...
                style={{
                  ...
                  visibility: this.state.openSite === true ? "visible" : "hidden",
                  width: this.state.openSite === true ? "100%" : "0px",
                  height: this.state.openSite === true ? "80vh" : "0px",
                }}
              >
                <iframe
                  ...
                  className="filePickerIFrame_d791363d"
                  role="application"
