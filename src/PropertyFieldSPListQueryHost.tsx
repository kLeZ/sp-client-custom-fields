          ...
          return (
            <div>
              ...
              <TextField
                ...
                onChanged={(value2: string) => this.onChangedFilterValue(value2, index)}
              />
  ...
  public getLibs(): Promise<ISPLists> {
    if (Environment.type === EnvironmentType.Local) {
      ...
      if (this.props.orderBy != null) {
        queryUrl += "&$orderby=";
        if (this.props.orderBy == PropertyFieldSPListQueryOrderBy.Id) queryUrl += "Id";
        else if (this.props.orderBy == PropertyFieldSPListQueryOrderBy.Title) queryUrl += "Title";
      }
