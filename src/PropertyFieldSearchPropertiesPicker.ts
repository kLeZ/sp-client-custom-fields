 ...
 */
export function PropertyFieldSearchPropertiesPicker(
  targetProperty: string,
  properties: IPropertyFieldSearchPropertiesPickerProps
): IPropertyPaneField<IPropertyFieldSearchPropertiesPickerPropsInternal> {
