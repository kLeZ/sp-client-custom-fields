...
class PropertyFieldMapPickerBuilder implements IPropertyPaneField<IPropertyFieldMapPickerPropsInternal> {
  ...
  public constructor(_targetProperty: string, _properties: IPropertyFieldMapPickerPropsInternal) {
    ...
    if (_properties.collapsed !== undefined) this.collapsed = _properties.collapsed;
 ...
 */
export function PropertyFieldMapPicker(
  targetProperty: string,
  properties: IPropertyFieldMapPickerProps
): IPropertyPaneField<IPropertyFieldMapPickerPropsInternal> {
