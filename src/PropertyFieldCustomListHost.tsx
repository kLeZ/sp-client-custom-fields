...
export default class PropertyFieldCustomListHost extends React.Component<IPropertyFieldCustomListHostProps, IPropertyFieldCustomListHostState> {
  ...
  private onClickAdd(): void {
    ...
    for (var i = 0; i < this.props.fields.length; i++) {
      if (this.props.fields[i] == null) continue;
    ...
    return (
      <div style={{ marginBottom: "8px" }}>
        ...
        <Dialog
          ...
          containerClassName={styles.msDialogMainCustom}
          isDarkOverlay={true}
          isBlocking={false}
        >
          <div style={{ width: "630px", height: "500px", overflow: "scroll" }}>
            {this.state.openListAdd === true ? (
              <div>
                {this.props.fields != null ? (
                  <div>
                    ...
                    {this.state.mandatoryOpen === true ? (
                      <MessageBar>{strings.CustomListFieldMissing.replace("{0}", this.state.missingField)}</MessageBar>
                    ) : (
                      ""
                    )}
                            ...
                            <tr key={this._key + "-customListTr1-" + indexF}>
                              ...
                              <td>
                                ...
                                {value.type == CustomListFieldType.dateTime ? (
                                  <div>
                                    <input id={"input-" + value.id} type="hidden" style={{ visibility: "hidden" }} />
                                    <PropertyFieldDateTimePickerHost
                                      render={null}
                                      key={"input-" + value.id}
                                      label=""
                                      properties={this.props.properties}
                                ...
                                {value.type == CustomListFieldType.fontSize ? (
                                  <div>
                                    <input id={"input-" + value.id} type="hidden" style={{ visibility: "hidden" }} />
                                    <PropertyFieldFontSizePickerHost
                                      render={null}
                                      key={"input-" + value.id}
                                      label=""
                                      properties={this.props.properties}
                                ...
                                {value.type == CustomListFieldType.colorMini ? (
                                  <div>
                                    <input id={"input-" + value.id} style={{ visibility: "hidden" }} />
                                    <PropertyFieldColorPickerMiniHost
                                      render={null}
                                      key={"input-" + value.id}
                                      label=""
                                      properties={this.props.properties}
                                ...
                                {value.type == CustomListFieldType.users ? (
                                  <div>
                                    ...
                                    <PropertyFieldPeoplePickerHost
                                      ...
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChangeJson}
                                      targetProperty={"input-" + value.id}
                                    />
                                  </div>
                                ) : (
                                ...
                                {value.type == CustomListFieldType.folder ? (
                                  <div>
                                    <input id={"input-" + value.id} type="hidden" style={{ visibility: "hidden" }} />
                                    <PropertyFieldSPFolderPickerHost
                                      render={null}
                                      key={"input-" + value.id}
                                      label=""
                                      properties={this.props.properties}
                                ...
                                {value.type == CustomListFieldType.officeVideo ? (
                                  <div>
                                    <input id={"input-" + value.id} type="hidden" style={{ visibility: "hidden" }} />
                                    <PropertyFieldOfficeVideoPickerHost
                                      render={null}
                ...
                <div style={{ marginTop: "30px", marginBottom: "30px" }}>
                  <PrimaryButton style={{ marginRight: "10px" }} onClick={this.onClickAdd}>
                    {strings.CustomListOK}
                  </PrimaryButton>
            ...
            {this.state.editOpen === true ? (
              <div>
                    ...
                    {this.state.mandatoryOpen === true ? (
                      <div className="ms-MessageBar">
                        ...
                        <div className="ms-MessageBar-content">
                          ...
                          <div className="ms-MessageBar-text">{strings.CustomListFieldMissing.replace("{0}", this.state.missingField)}</div>
                        </div>
                      </div>
                    ) : (
                      ""
                              ...
                              <td>
                                ...
                                {value.type == CustomListFieldType.date ? (
                                  <div>
                                    ...
                                    <PropertyFieldDatePickerHost
                                      ...
                                      key={"input-" + value.id}
                                      properties={this.props.properties}
                                      initialDate={this.state.data[this.state.selectedIndex][value.id]}
                                      label=""
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChange}
                                ...
                                {value.type == CustomListFieldType.font ? (
                                  <div>
                                    ...
                                    <PropertyFieldFontPickerHost
                                      ...
                                      label=""
                                      properties={this.props.properties}
                                      initialValue={this.state.data[this.state.selectedIndex][value.id]}
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChange}
                                      targetProperty={"input-" + value.id}
                                ...
                                {value.type == CustomListFieldType.color ? (
                                  <div>
                                    ...
                                    <PropertyFieldColorPickerHost
                                      ...
                                      properties={this.props.properties}
                                      label=""
                                      initialColor={this.state.data[this.state.selectedIndex][value.id]}
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChange}
                                      targetProperty={"input-" + value.id}
                                ...
                                {value.type == CustomListFieldType.users ? (
                                  <div>
                                    <input
                                      id={"input-" + value.id}
                                      type="hidden"
                                      defaultValue={JSON.stringify(this.state.data[this.state.selectedIndex][value.id])}
                                      style={{ visibility: "hidden" }}
                                    />
                                    <PropertyFieldPeoplePickerHost
                                      render={null}
                                      ...
                                      properties={this.props.properties}
                                      label=""
                                      initialData={this.state.data[this.state.selectedIndex][value.id]}
                                      context={this.props.context}
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChangeJson}
                                ...
                                {value.type == CustomListFieldType.list ? (
                                  <div>
                                    ...
                                    <PropertyFieldSPListPickerHost
                                      ...
                                      properties={this.props.properties}
                                      label=""
                                      selectedList={this.state.data[this.state.selectedIndex][value.id]}
                                      context={this.props.context}
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChange}
                                ...
                                {value.type == CustomListFieldType.folder ? (
                                  <div>
                                    ...
                                    <PropertyFieldSPFolderPickerHost
                                      ...
                                      properties={this.props.properties}
                                      label=""
                                      initialFolder={this.state.data[this.state.selectedIndex][value.id]}
                                      context={this.props.context}
                                      onDispose={null}
                                      onRender={null}
                                      onPropertyChange={this.onPropertyChange}
                                ...
                                {value.type == CustomListFieldType.stars ? (
                                  <div>
                                    ...
                                    <PropertyFieldStarRatingHost
                                      render={null}
                                      initialValue={Number(this.state.data[this.state.selectedIndex][value.id])}
                                      key={"input-" + value.id}
                                      properties={this.props.properties}
                                      label=""
                                      context={this.props.context}
                ...
                <div style={{ marginTop: "30px", marginBottom: "30px" }}>
                  <PrimaryButton style={{ marginRight: "10px" }} onClick={this.onClickUpdate}>
                    {strings.CustomListOK}
                  </PrimaryButton>
                  <DefaultButton onClick={this.onClickCancel}>{strings.CustomListCancel}</DefaultButton>
                </div>
            ...
            {this.state.openListView === true ? (
              <div>
                <CommandBar
                  ...
                  items={[
                    { key: "Add", icon: "Add", title: strings.CustomListAddItem, name: "Add", onClick: this.onClickAddItem },
                    {
                      key: "Edit",
                      icon: "Edit",
                      title: strings.CustomListEdit,
                      name: "Edit",
                      onClick: this.onClickEdit,
                      disabled: this.state.selectedIndex == null || this.state.selectedIndex < 0 ? true : false,
                    },
                    {
                      key: "Delete",
                      icon: "Delete",
                      title: strings.CustomListDel,
                      name: "Delete",
                    ...
                    },
                    {
                      ...
                      disabled:
                        this.state.selectedIndex == null || this.state.selectedIndex < 0 || this.state.selectedIndex >= this.state.data.length - 1
                          ? true
                          : false,
                    },
                  ]}
                ...
                <Dialog
                  ...
                  title={strings.CustomListConfirmDel}
        ...
        <DefaultButton disabled={this.props.disabled} onClick={this.onOpenPanel}>
